/**
 * 02_vectorcpp14.cc
 * Definition and implementation of a simple, didactic std::vector class, making use of C++14 features.
 * Almost-totally based on previous work by Alberto Sartori (alberto.sartori@sissa.it)
