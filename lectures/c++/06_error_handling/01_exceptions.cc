...
int main()
{
    ...
    catch (...)  // in the catch() clause, the ... MEANS "all the other exceptions/errors"
    {
...
/*
NOTE:
        - Pre-conditions are conditions that are checked on sth BEFORE the function is called;
        - Post-conditions are checks that I can perform afterwards, i.e. on THE RETURN.
*/
